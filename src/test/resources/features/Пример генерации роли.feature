...
Функция: Примеры генерации роли
  ...
  @generation_sample
  Сценарий: Вывести на экран данные сгенерированной роли
    Пусть В системе существует роль "роль" с параметрами:
      | Позиция                               | 1                         |
      | Встроенная                            | 0                         |
      | Задача может быть назначена этой роли | true                      |
      ...
      | Видимость пользователей               | Все активные пользователи |
      | Видимость трудозатрат                 | Все трудозатраты          |
    И Вывести на экран строку "Сгенерированная роль имеет видимость задач ${роль -> Видимость задач}, позицию ${роль -> Позиция}, наименование ${роль -> Наименование}"
    И Вывести на экран строку "Сгенерированная роль имеет позицию ${роль->Позиция}"
    И Вывести на экран строку "Сгенерированная роль имеет наименование ${ роль -> Наименование }"